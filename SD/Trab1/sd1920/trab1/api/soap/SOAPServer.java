...
import sd1920.trab1.server.implementations.MessageServiceImpl;
import sd1920.trab1.server.implementations.UserServiceImpl;
...
public class SOAPServer {
	...
	public static void main(String[] args) throws Exception {
		...
		Endpoint soapMessagesEndpoint = Endpoint
				.create(new MessageServiceImpl(InetAddress.getLocalHost().getHostName(), discovery));
		
		Endpoint soapUsersEndpoint = Endpoint
				.create(new UserServiceImpl(InetAddress.getLocalHost().getHostName(), discovery));
