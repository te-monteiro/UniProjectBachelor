...
public interface MessageService {
	...
	@Consumes(MediaType.APPLICATION_JSON)
	@Produces(MediaType.APPLICATION_JSON)
	List<String> postMessageOutside(Message msg);
	...
	@Path("/mbox/{user}/{mid}")
	@Produces(MediaType.APPLICATION_JSON)
	Message getMessage(@PathParam("user") String user, @PathParam("mid") long mid, @QueryParam("pwd") String pwd);
	...
	@DELETE
	@Path("/mbox/{user}/{mid}")
	void removeFromUserInbox(@PathParam("user") String user, @PathParam("mid") long mid, @QueryParam("pwd") String pwd);
	...
	@DELETE
	@Path("/ext/msg/{mid}")
	void processDelete(@PathParam("mid") long mid);
	...
	@Path("/mbox/{user}")
	@Consumes(MediaType.APPLICATION_JSON)
	void postInbox(@PathParam("user") String user);
	...
	@DELETE
	@Path("/mbox/{user}")
	void removeInbox(@PathParam("user") String user);
