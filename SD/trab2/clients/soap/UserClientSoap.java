...
public class UserClientSoap extends EmailClientSoap implements UsersEmailClient {
	...
	public EmailResponse<User> getUser(String name, String pwd) {
		// Calls the tryMultiple method of EmailClientSoap to repeat the operation until
		// it is successful,
	...
	// this method creates a new UserServiceSoap proxy, or returns the existing one
