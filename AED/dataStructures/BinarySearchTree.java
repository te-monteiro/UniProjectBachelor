...
{                                                                   
     ...
     * @return key-order iterator  the entries in the dictionary
     */
    ...
    /**
     * Returns an iterator of the value (getValue() of the entry) in the dictionary
     * which preserves the key order relation
     * @return key-order iterator of the values (of each entry) in the dictionary
     */
    public Iterator<V> valueIterator(){
		return new BSTValueOrderIterator<K, V>(root);
    }
